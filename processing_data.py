...
def combine_csv_files():
    ...
    csv_dir = r"C:\Users\clint\Desktop\Lifecycle_RA\Data\Processed\Csvs"
    ...
    for csv_file in csv_files:
        ...
        # Drop columns containing 'Dycb' or 'Dycab'
        dycb_columns = df.columns[df.columns.str.contains('Dycb|Dycab')]
        if not dycb_columns.empty:
            print(f"Dropping columns: {list(dycb_columns)}")
            df = df.drop(columns=dycb_columns)
        
        # Standardize column names like "5YO Slpr." to "5YO"
